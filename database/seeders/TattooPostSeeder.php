...
class TattooPostSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $barcos = Category::where('name', 'Old School - Barcos & Anclas')->first()?->id;
        $animales = Category::where('name', 'Old School - Animales')->first()?->id;
        $calaveras = Category::where('name', 'Old School - Calaveras')->first()?->id;
        $flores = Category::where('name', 'Old School - Flores')->first()?->id;
        $corazones = Category::where('name', 'Old School - Corazones & Flechas')->first()?->id;
