<aside class="relative w-64 p-6 text-gray-800 bg-gradient-to-b from-yellow-100 via-yellow-200 to-yellow-100 shadow-inner border-r border-yellow-300
    ...
    @auth
        <div>
            <div class="relative w-[15rem] h-[15rem] flex-shrink-0">
                <img src="storage/texturas/MarcoFoto.png" class=" h-full w-full" alt="marco de foto de usuario">
                <img src="{{Auth::user()->avatar}}" class="absolute h-[8rem] w-[8rem]" alt="foto de perfil del usuario"
                style="
                bottom:4rem;
                left:3.53rem;
                ">
                    ...
                    @if($item['dropdown'])
                        ...
                        <li class="relative overflow-visible">
                            ...
                            <div x-show="isOpen"
                                ...
                                style="left: 360px; top: 100px;">
                                
                                {{-- Si hay notificaciones --}}
                                <div x-show="notifications.length > 0">
                                    <div x-for="notification in notifications" :key="notification.id" class="border-b p-3 bg-amber-200/50 shadow-[inset_0_0_20px_rgba(255,253,101,0.8)] hover:bg-gray-50 dark:hover:bg-stone-800"
    ...
    <div style="position:absolute; top: 7rem;">
        <img src="storage/texturas/PleaseLogInLogo.png" alt="logo de please log in" class="opacity-55">
        <span
